        ...
        <>
          ...
          <div className="grid gap-4 xl:grid-cols-2">
            ...
            >
              {series.length === 0 ? (
                <Empty>
                  No COMPENSATION_ASSESSED or PAYMENT_MADE events in scope yet.
                </Empty>
              ) : (
                <div className="h-64">
                  <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={series} margin={{ top: 8, right: 12, left: 4, bottom: 4 }}>
                      ...
                      <Tooltip
                        ...
                        contentStyle={{ fontSize: 12, borderRadius: 4, border: `1px solid ${C.border}` }}
                      />
            ...
            >
              {clockData.length === 0 ? (
                <Empty>No statutory clocks have been evaluated in scope.</Empty>
              ) : (
                <div className="h-64">
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={clockData} margin={{ top: 8, right: 12, left: 4, bottom: 4 }}>
                      ...
                      <Bar dataKey="count" name="Clocks">
                        {clockData.map((row) => (
                          <Cell
                            key={row.key}
                            fill={CLOCK_STATUS_COLOUR[row.key] ?? C.muted}
                          />
                        ))}
                      </Bar>
                    </BarChart>
